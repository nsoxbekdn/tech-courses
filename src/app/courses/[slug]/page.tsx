        ...
        <div className="container-page relative z-10 grid gap-8 py-12 lg:grid-cols-[1.6fr_1fr]">
          <div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="tag border-white/30 bg-white/20 text-white">
                {course.level}
              </span>
              {course.code && (
                <span className="tag border-white/25 bg-white/15 text-white">
                  {course.code}
                </span>
              )}
            </div>
            ...
            <p className="mt-3 max-w-2xl text-lg text-white">{course.subtitle}</p>

            <div className="mt-5 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-white">
